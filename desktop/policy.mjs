...
export const DESKTOP_ACTIONS = Object.freeze(['status', 'install-hooks', 'remove-hooks', 'install-claude-hooks', 'remove-claude-hooks', 'extension-folder', 'login', 'updates', 'quit', 'copy-support']);
